...
variable "instance_type" {
  type        = string
  description = "(Required) t2.micro  free instance_type"
  default     = "t2.micro"
}
...
#}
#
variable "prov_file_source" {
  type        = string
  description = " "
  default     = null
}

variable "prov_file_destination" {
  type        = string
  description = " "
  default     = null
}
...
variable "net_interface_statements" {
  type        = any
  description = "(optional)  . "
  default     = []
}

variable "connection_statements" {
  type        = any
  description = "(optional)  . "
  default     = []
}
