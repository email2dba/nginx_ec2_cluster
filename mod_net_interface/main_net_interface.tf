...
resource "aws_network_interface" "main_net_interface" {
...
output "net_interface_id" {
  value = aws_network_interface.main_net_interface.id
}

output "net_interface_mac_address" {
  value = aws_network_interface.main_net_interface.mac_address
}
